export const els = {
  ...
  settingsEnable2faBtn: document.getElementById("settings-enable-2fa-btn"),
  settingsDisable2faBtn: document.getElementById("settings-disable-2fa-btn"),
  settings2faStatus: document.getElementById("settings-2fa-status"),
  totpEnrollModal: document.getElementById("totp-enroll-modal"),
  totpEnrollBackdrop: document.getElementById("totp-enroll-backdrop"),
  totpEnrollCancel: document.getElementById("totp-enroll-cancel"),
  totpEnrollConfirm: document.getElementById("totp-enroll-confirm"),
  totpVerifyCode: document.getElementById("totp-verify-code"),
  totpEnrollStatus: document.getElementById("totp-enroll-status"),
